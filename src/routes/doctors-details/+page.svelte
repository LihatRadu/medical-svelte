<div class="text-center">
  <h1 class="text-5xl font-bold text-indigo-800 py-20">Doctor Details List</h1>
</div>

<div id="doctors" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 justify-between space-x-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
<div class="flow-root border-black">
  <dl class="-my-3 divide-y divide-gray-100 text-sm">
    ...
    <div class="grid grid-cols-1 gap-1 py-3 sm:grid-cols-3 sm:gap-4">
      ...
      <dd class="text-gray-700 sm:col-span-2">Dentist</dd>
    </div>
